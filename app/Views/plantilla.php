...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/mi-estilo.css'); ?>">
...
<section>
  <nav class="navbar navbar-expand-lg bg-danger rounded-pill mt-3">
    ...
    <ul class="navbar-nav mx-auto d-none d-lg-flex">
      ...
      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="proyecto1/principal">Principal</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="proyecto2/catalogo">Servicios</a>
      </li>      <li class="nav-item">
        <a class="nav-link text-white fw-bold" href="proyecto1/quienes-somos">Quienes Somos</a>
      </li>
      <li class="nav-item">
